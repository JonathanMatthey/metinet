...
(function() {
    ...
    function angularMoment(angular, moment) {
         ...
         * @restrict A
         */
        .directive('amTimeAgo', ['$window', 'moment', 'amMoment', 'amTimeAgoConfig', 'angularMomentConfig',
            function($window, moment, amMoment, amTimeAgoConfig, angularMomentConfig) {
         ...
         * @module angularMoment
         */
        .service('amMoment', ['moment', '$rootScope', '$log', 'angularMomentConfig',
            function(moment, $rootScope, $log, angularMomentConfig) {
                var that = this;
                /**
                 * @ngdoc property
         ...
         * @function
         */
        .filter('amDurationFormat', ['moment',
            function(moment) {
