...
angular.module('app.services',[])
	.factory('Countries', ['$resource', function($resource) {
		return $resource('http://api.metinet.co/countries', {}, {});
	}])
	.factory('Currencies', ['$resource', function($resource) {
		return $resource('http://api.metinet.co/currencies', {}, {});
	}])	
	...
	.factory('NetworkLocations', ['$resource', function($resource) {
		return $resource('http://api.metinet.co/networks/:network_id/locations/:loc_id',{
			network_id:'@network_id',
			loc_id:'@loc_id'
		}, {
			update: {
